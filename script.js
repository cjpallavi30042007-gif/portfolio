...
document.querySelector(".site-footer p").innerHTML =
  `&copy; ${year} Pallavi CJ. All rights reserved`;
...
if (hero) {
  hero.textContent = `${getGreeting()}, I'm Pallavi CJ👋`;
}
...
const projects = [
  ...
  { id: 2, name: "QuickCal", category: "web", tech: ["JavaScript"] },
  { id: 3, name: "TickTask", category: "design", tech: ["HTML", "CSS"] },
  { id: 4, name: "TimeCraf", category: "web", tech: ["JavaScript"] },
];
